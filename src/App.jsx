...
import "./App.css";
import { DisponibilidadDocentePage } from "./pages/docentes/DisponibilidadDocentePage";
import DocenteHorario from "./components/DocenteHorario";
        ...
        >
          ...
          <div style={{ flex: 1, padding: "20px" }}>
            <Routes>
              ...
              <Route path="disponibilidad-docente">
                <Route index element={<DisponibilidadDocentePage />} />
                <Route path=":professorId" element={<DocenteHorario />} />
              </Route>
            </Routes>
          </div>
        </div>
