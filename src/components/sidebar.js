                ...
                <ul>
                    <li>
                        <button onClick={() => toggleSection('main')}>
                            <FontAwesomeIcon icon={faHome} /> Main <span className="arrow">{activeSection === 'main' ? '︿' : '﹀'}</span>
                        </button>
                    ...
                    <li>
                        <button onClick={() => toggleSection('coordinador')}>
                            <FontAwesomeIcon icon={faUserTie} /> Coordinador <span className="arrow">{activeSection === 'coordinador' ? '︿' : '﹀'}</span>
                        </button>
                        <ul className={`submenu ${activeSection === 'coordinador' ? 'open' : ''}`}>
                            ...
                            <li><Link to="/gestionar-semestre">Gestionar Semestre</Link></li>
                    ...
                    <li>
                        <button onClick={() => toggleSection('docente')}>
                            <FontAwesomeIcon icon={faChalkboardTeacher} /> Docente <span className="arrow">{activeSection === 'docente' ? '︿' : '﹀'}</span>
                        </button>
