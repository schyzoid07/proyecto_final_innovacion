...
const Gestioncarrera = () => {
    const [searchTerm, setSearchTerm] = useState('');
    const [data, setData] = useState([
        { id: 1, nombre: 'Ingeniería en Informática' },
        { id: 2, nombre: 'Ingeniería Industrial' },
        { id: 3, nombre: 'Ingeniería en Materiales' },
        { id: 4, nombre: 'Educación Mención Lenguaje y Literatura' },
    ]);
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-2xl">Gestión de Proyectos de Carrera</h1>
                <button
                    onClick={() => setIsAddModalOpen(true)}
                    className="custom-button"
                >
                    <i className="fas fa-plus icon-spacing"></i> Agregar Proyecto de Carrera
                </button>
            ...
            {editData && (
                <div className="modal-overlay-custom">
                    <div className="custom-card-edit">
                        <h2 className="custom-card-title">Editar Proyecto de Carrera</h2>
            ...
            {isAddModalOpen && (
                <div className="modal-overlay-custom">
                    <div className="custom-card-edit">
                        <h2 className="custom-card-title">Agregar Proyecto de Carrera</h2>
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <div className="mb-4 col-span-2">
                                <label className="custom-label-text">Nombre</label>
                                <input
